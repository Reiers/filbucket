...
# macOS Keychain on modern systems requires legacy PKCS12 format with an
# actual password. Use "changeit" as a sentinel everyone-knows password since
# this cert is purely for local code-sign and never leaves the machine.
P12_PASS=changeit
